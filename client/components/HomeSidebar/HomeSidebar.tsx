...
export default function HomeSidebar() {
  return (
    <div className="HomeSidebar pt-16 w-60 h-[100vh] bg-neutral-950 shadow-2xl overflow-scroll">
      ...
      <Link href={"/login"} className="text-red-500 font-semibold text-lg flex items-center justify-center w-auto h-[7vh] mx-4 border border-red-500 rounded-md bg-neutral-800 hover:bg-neutral-900 cursor-pointer">
        Log in
      </Link>
      <HomeSideFooter />
    </div>
