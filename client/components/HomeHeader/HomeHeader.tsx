...
export default function HomeHeader() {
  return (
    <div className="flex justify-between py-2 w-full fixed bg-neutral-950 h-16">
      {/* logo of tiktok */}
      <Image
      ...
      <span className="flex justify-between w-40 h-12 items-center text-left mr-7">
        <button className="bg-red-500 text-white w-28 h-10 rounded font-bold hover:bg-red-600">
          Log in
        </button>
